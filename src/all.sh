...
then # I am root, make the prompt different
    ...
    PS1="\[\033[38;5;11m\][\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;13m\]\@\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;11m\]]\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;10m\]\u@\h\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;12m\]\w\[$(tput sgr0)\] \[$(tput sgr0)\]\[\033[38;5;10m\]\\$\[$(tput sgr0)\]\n\[$(tput sgr0)\]\[\033[01;38;5;13m\]❯\[$(tput sgr0)\]\[\033[01;38;5;11m\]❯\[$(tput sgr0)\]\[\033[01;38;5;10m\]❯\[$(tput sgr0)\] \[$(tput sgr0)\]"
fi
